    ...
    public class Actions
    {
        ...
        private void Help()
        {
            manager.RootContainer.Loop.OnPaused = () =>
            {
                ...
                Console.WriteLine(
                    "Для навигации можно и нужно использовать стрелочки и клавиши PageUp, PageDown, Home, End");
                Console.WriteLine(
                    "Чтобы выполнить команду, необходимо сначала выбрать файлы или директории при помощи" +
                    " клавиш Пробел или Ins, после чего нажать соответствующую клавишу.");
                Console.WriteLine(
                    "Если необходимо отменить выбор того или иного файла, то нужно перейти в правую панель" +
                ...
                Console.WriteLine(
                    "Чтобы перейти в другую директорию, нужно выделить папку в левой панели и нажать Enter." +
                    " Если выделить **файл** и нажать Enter, то отобразятся некоторые его свойства.");
                Console.WriteLine();
                Console.WriteLine(
                    "Правая панель может закрывать список команд. Но всегда можно нажать F1, чтобы увидеть их снова.");
